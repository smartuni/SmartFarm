...
printf("*                                                                          *\n");
printf("*   Version:1.0 (Mock-UP)                                                  *\n");
printf("*   Last modification:06.05.2017                                           *\n");
printf("*   Name: Smartfarm.c                                                      *\n");
printf("*                                                                          *\n");
printf("*   To-Do: -test with real boards                                          *\n");
printf("*          -implementation func(IEEE 802.15.4 )                            *\n");
printf("*          -implementation Lora                                            *\n");
printf("*          -Communication to RasPi (CoAP)                                  *\n");
printf("*          -Error-handling                                                 *\n");
printf("*                                                                          *\n");
printf("*   NOTICE: This program only runs with native!!!!                         *\n");
printf("*                                                                          *\n");
printf("****************************************************************************\n");
printf("\n\n\n\n");
